...
env.info("killbox loading", false)
...
KILLBOX.menuTop = MENU_COALITION:New(coalition.side.BLUE, "SAM KILLBOX - GRID ES/ER")
...
KILLBOX.zones = {
  { zoneName = "Kill Box NW", kbName = "NW", menuText = "Killbox NW"},
  { zoneName = "Kill Box NE", kbName = "NE", menuText = "Killbox NE"},
  { zoneName = "Kill Box SW", kbName = "SW", menuText = "Killbox SW"},
  { zoneName = "Kill Box SE", kbName = "SE", menuText = "Killbox SE"},
  }
...
KILLBOX.threats = {
  ...
  { spawnTemplate = "kbConvoy-Armed",   menuText = "Activate Armed Convoy", threatText = "AAA/IR/RF"},
  }
