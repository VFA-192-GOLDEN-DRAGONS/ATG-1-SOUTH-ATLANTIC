...
if mission_era == "cold_war" then
	usa_awacs_type = "E-2C"
	usa_awacs_livery = "VAW-111 Knights"
	awacs_frequency = 251
	else
	usa_awacs_type = "E-3A"
	usa_awacs_livery = "nato"
	awacs_frequency = 251
end
		...
		[20] = {
                ...
                ["units"] = 
                {
                    [1] = { ["alt"] = RedAirRouteAltitude,
                            ["hardpoint_racks"] = true,
                            ["alt_type"] = "BARO",
							["livery_id"] = "VI Escadre de chasse Atlas",
